...
import com.axonivy.connector.casemailcomponent.enums.NotificationTaskType;
import com.axonivy.connector.casemailcomponent.model.CustomTaskDefinition;
...
import com.axonivy.connector.casemailcomponent.utils.IvyUtil;
import com.axonivy.connector.casemailcomponent.utils.MessageComparator;
...
public abstract class AbstractEmailHandler {
	...
	private String formatWithEmailReadableMetadata(String info, String mailBoxName, String mailSubject,
		...
		return com.axonivy.connector.casemailcomponent.enums.BpmErrorCode.RECEIVE_MAIL_PROCESSING_MESSAGE.getCmsMessage(info,
